...
export default function IncomeClient() {
    ...
    const [selectedPeriod, setSelectedPeriod] = useState<'month' | 'quarter' | 'year' | 'all'>('year');
    ...
    const stats = useMemo(() => {
        ...
        if (selectedPeriod === 'month') {
            ...
            const prevMonthItems = salaryItems.filter(item => {
                const itemDate = new Date(item.date);
                return itemDate.getMonth() === prevMonth.getMonth() && 
    ...
    const employersData = useMemo(() => {
        const employersMap = stats.filteredItems.reduce((acc, item) => {
    ...
    return (
        <div className="main-content" style={{ backgroundColor: '#020617', minHeight: '100vh', color: '#f8fafc', padding: '24px 20px' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{
                        ...
                        <div style={{ position: 'relative', zIndex: 1 }}>
                            ...
                            <div style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', fontWeight: '900', color: '#10b981', marginBottom: '8px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: 'relative', zIndex: 1 }}>
                            ...
                            <div style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', fontWeight: '900', color: '#6366f1', marginBottom: '8px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: 'relative', zIndex: 1 }}>
                            ...
                            <div style={{ fontSize: 'clamp(2rem, 4vw, 2.5rem)', fontWeight: '900', color: '#f59e0b', marginBottom: '8px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 450px), 1fr))', gap: '32px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                            {employersData.length > 0 ? employersData.map((employer, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
                                            <div style={{ flex: 1 }}>
                                                <div style={{ fontWeight: '800', fontSize: '1rem', color: '#fff', marginBottom: '6px' }}>
                                                    {employer.name}
                                                </div>
                                                <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: '600' }}>
                                                    {employer.count} payment{employer.count !== 1 ? 's' : ''} • Last: {new Date(employer.lastPayment).toLocaleDateString('en-IN', { month: 'short', day: 'numeric' })}
                                                </div>
                                            </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', maxHeight: '600px', overflowY: 'auto' }}>
                            {stats.filteredItems.length > 0 ? stats.filteredItems.slice(0, 10).map((item) => (
                                <div 
                                    key={item.id}
                                    style={{
                                        padding: '18px',
                                ...
                                >
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        <div style={{ fontWeight: '800', fontSize: '0.95rem', color: '#fff', marginBottom: '4px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                            {item.description}
                                        </div>
                                        <div style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: '600' }}>
                                ...
                                <div style={{ 
                                    ...
                                    <p style={{ fontWeight: '700', fontSize: '1.1rem', marginBottom: '8px' }}>No income recorded</p>
                                    <p style={{ fontSize: '0.9rem' }}>Start tracking your earnings by adding your first income entry</p>
                                    <button
                                        onClick={() => setIsModalOpen(true)}
                                        style={{
                                            marginTop: '20px',
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        <form onSubmit={handleLogIncome} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                            <div>
                                <label style={{ fontSize: '0.8rem', fontWeight: '800', color: '#94a3b8', textTransform: 'uppercase', display: 'block', marginBottom: '10px', letterSpacing: '0.5px' }}>
