...
import { Undo, Layers, Info, LayoutPanelLeft, Eye } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const resetToDefaults = async () => {
    const isConfirmed = await customConfirm({
      ...
      message:
        'Are you sure you want to reset all math engine and workflow defaults to their original states? This action cannot be undone.',
      type: 'warning',
      confirmLabel: 'Reset',
    });
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings({
                        defaultStockAccountId: e.target.value ? Number(e.target.value) : undefined,
                      })
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings({
                        defaultMfAccountId: e.target.value ? Number(e.target.value) : undefined,
                      })
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateSettings({
                        defaultSalaryAccountId: e.target.value ? Number(e.target.value) : undefined,
                      })
                    }
            ...
            >
              ...
              >
                Enable or disable tracking modules. Your data is never deleted when you disable a
                module.
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '0.8rem', color: '#94a3b8' }}>
                      Track NCDs and Corporate Bonds
                    </div>
                  </div>
                  <div
                    ...
                    style={{
                      width: '52px',
                      height: '28px',
                      background: settings.bondsEnabled ? '#10b981' : '#334155',
                      borderRadius: '100px',
                      cursor: 'pointer',
                      position: 'relative',
                      transition: 'background 0.3s',
                      boxShadow: settings.bondsEnabled
                  ...
                  >
                    <div
                      style={{
                        ...
                        position: 'absolute',
                        top: '3px',
                        left: settings.bondsEnabled ? '27px' : '3px',
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '0.8rem', color: '#94a3b8' }}>
                      Track forex deposits, trades & withdrawals
                    </div>
                  </div>
                  <div
                    ...
                    style={{
                      width: '52px',
                      height: '28px',
                      background: settings.forexEnabled ? '#2dd4bf' : '#334155',
                      borderRadius: '100px',
                      cursor: 'pointer',
                      position: 'relative',
                      transition: 'background 0.3s',
                      boxShadow: settings.forexEnabled
                  ...
                  >
                    <div
                      style={{
                        ...
                        position: 'absolute',
                        top: '3px',
                        left: settings.forexEnabled ? '27px' : '3px',
                        transition: 'left 0.3s',
                        boxShadow: '0 2px 4px rgba(0,0,0,0.2)',
                      }}
                    />
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  {
                    key: 'stocksVisible',
                    label: 'Stocks',
                    desc: 'Equity portfolio tracking',
                    color: '#10b981',
                    icon: '📈',
                  },
                  {
                  ...
                  },
                  {
                    key: 'fnoVisible',
                    label: 'FnO',
                    desc: 'Futures & options trading log',
                    color: '#a78bfa',
                    icon: '⚡',
                  },
                  {
                    key: 'ledgerVisible',
                    label: 'Ledger',
                    desc: 'Transaction history & records',
                    color: '#60a5fa',
                    icon: '📖',
                  },
                  {
                ...
                >
                  <strong style={{ color: '#94a3b8', display: 'block', marginBottom: '4px' }}>
                    💡 Note:
                  </strong>
                  Bonds and Forex visibility is controlled separately via Module Toggles above.
                  Dashboard and Accounts sections are always visible.
                </div>
              </div>
            </div>
            ...
            >
              <div style={{ display: 'flex', gap: '14px', alignItems: 'start' }}>
                ...
                <div>
                  ...
                  >
                    Your settings are stored in your browser&apos;s local storage. When
                    transitioning to cloud sync, your preferences will be automatically backed up.
                  </p>
                </div>
              </div>
            </div>
