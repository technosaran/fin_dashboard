                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '48px', flexWrap: 'wrap', gap: '16px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                        <button
                            ...
                            style={{ padding: '12px 24px', borderRadius: '16px', background: 'rgba(255,255,255,0.03)', color: '#94a3b8', border: '1px solid #1e293b', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap' }}
                        >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', gap: '16px', flexWrap: 'wrap' }}>
                                ...
                                <div
                                    ...
                                    style={{ width: '50px', height: '26px', background: localSettings.autoCalculateCharges ? '#6366f1' : '#1e293b', borderRadius: '100px', cursor: 'pointer', position: 'relative', transition: '0.3s', flexShrink: 0 }}
                                >
