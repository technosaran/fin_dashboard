...
export const NotificationProvider = ({ children }: { children: ReactNode }) => {
    ...
    const getIcon = (type: NotificationType) => {
        switch (type) {
            ...
            case 'error': return <AlertOctagon size={20} color="#f43f5e" />;
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                            ...
                            <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: '900', color: '#fff' }}>{confirmDialog.options.title}</h3>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '12px' }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    padding: '14px',
                                    borderRadius: '12px',
                                    background: confirmDialog.options.type === 'error' ? '#f43f5e' : 'linear-gradient(135deg, #6366f1 0%, #4338ca 100%)',
                                    border: 'none',
                                    color: '#fff',
                                    fontWeight: '700',
                                    cursor: 'pointer'
