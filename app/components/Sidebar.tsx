...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
    ...
    const navSections: NavSection[] = [
        ...
        },
        {
            title: 'INVESTMENTS',
            items: [
                { label: 'Stocks', href: '/stocks', icon: <TrendingUp size={18} />, color: '#10b981', settingsKey: 'stocksVisible' },
                { label: 'Mutual Funds', href: '/mutual-funds', icon: <Activity size={18} />, color: '#f59e0b', settingsKey: 'mutualFundsVisible' },
